...
public class Ferrovias{
	...
	private static Ferrovias instance = null;
	
	private Ferrovias(int totCid){
	...
	public static Ferrovias getInstance(int totCid){
		if(instance == null){
			instance = new Ferrovias(totCid);
		}
		return instance;
	}

	/* Método para inserir valores na matriz */
	public void setMatriz(char i, char j, int dist){
		 ...
		 */		
		this.cidadesAdj[i - 65][j - 65] = dist;
	}
	...
	public void imprime(int[][] a, int dim){
